function varargout = plaque2GUIubuntu(varargin)
% PLAQUE2GUIUBUNTU MATLAB code for plaque2GUIubuntu.fig
%      PLAQUE2GUIUBUNTU, by itself, creates a new PLAQUE2GUIUBUNTU or raises the existing
%      singleton*.
%
%      H = PLAQUE2GUIs returns the handle to a new PLAQUE2GUIUBUNTU or the handle to
%      the existing singleton*.
%
%      PLAQUE2GUIUBUNTU('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PLAQUE2GUIUBUNTU.M with the given input arguments.
%
%      PLAQUE2GUIUBUNTU('Property','Value',...) creates a new PLAQUE2GUIUBUNTU or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before plaque2GUIubuntu_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to plaque2GUIubuntu_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help plaque2GUIubuntu

% Last Modified by GUIDE v2.5 18-Nov-2014 16:20:13

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @plaque2GUIubuntu_OpeningFcn, ...
    'gui_OutputFcn',  @plaque2GUIubuntu_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
if isdeployed % Stand-alone mode.
    ...
    currentDir = fullfile(ctfroot,'Plaque2'); %char(regexpi(result, 'Path=(.*?);', 'tokens', 'once'));
...
% --- Executes just before plaque2GUIubuntu is made visible.
function plaque2GUIubuntu_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to plaque2GUIubuntu (see VARARGIN)
...
% Choose default command line output for plaque2GUIubuntu
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes plaque2GUIubuntu wait for user response (see UIRESUME)
...
function varargout = plaque2GUIubuntu_OutputFcn(hObject, eventdata, handles)
