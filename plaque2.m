...
%                     
    ...
    if(exist('ObjectDataArray') == 1)
        ...
        %Order struct fields
        [ObjectDataArray,perm] = orderfields(ObjectDataArray,{'wellRow','wellCollumn','Area','Centroid','BoundingBox','MajorAxisLength','MinorAxisLength','Eccentricity','ConvexArea','Roundness','numberOfPeaks','numberOfNucleiInPlaque','numberOfInfectedNucleiInPlaque','maxIntensityGFP','totalIntensityGFP','meanIntensity'});
