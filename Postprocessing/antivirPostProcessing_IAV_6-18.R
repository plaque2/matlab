...
# User input
plaqueOutputFile <- 'N:/antivir_screen/6-prestwick/6-18_IAV_preZ/Results/170901-6-18-IAV-preZ_Plate_706_ImageData.csv'
layoutFile <- 'N:/antivir_screen/6-prestwick/6-18_IAV_preZ/Layouts/preZ_p10_vIAV_d1e5.csv'
...
imagingPlateNumber = str_match(plaqueOutputFile, '(^.*/170901-6-18-IAV-preZ_Plate_(.+)_ImageData.csv$)')[,3]
head(imagingPlateNumber)

# Output setup
plotTitle = 'PreZ: IAV (1:500,000), 1 dpi on A549 ATCC'
outputPlotDirectory <- 'N:/antivir_screen/6-prestwick/6-18_IAV_preZ/Results/postprocessed/Graphs/' 
outputPlotNameBase <- paste(virusName, virusDilution, sep="_")
outputAnalysisDirectory <- 'N:/antivir_screen/6-prestwick/6-18_IAV_preZ/Results/postprocessed/'
...
plaquesDFT_DMSO_mean = mean(plaqueOut_infected[plaqueOut_infected$drug=='DMSO', 'numberOfPlaques'])
