...
# user input
plaqueOutputFile <- 'N:/antivir_screen/6-prestwick/6-4_virus_establishment/Results/160524-AntiVir-virus1_Plate_2676_ImageData.csv'
layoutFile <- 'N:/antivir_screen/6-prestwick/6-4_virus_establishment/Layouts/Est_p1_vHAdV_d4e6.csv'
