...
# User input
plaqueOutputFile <- 'Z:/antivir_screen/6-prestwick/6-14_IAV_titratration/170702-6-14-IAV-p3-frozen_Plate_224/Results/170702-6-14-IAV-p3-frozen_Plate_224_ImageData.csv'
layoutFile <- 'Z:/antivir_screen/6-prestwick/6-14_IAV_titratration/170702-6-14-IAV-p3-frozen_Plate_224/Layouts/BafA_frozen_p3_vIAV_dtitration.csv'
...
outputPlotDirectory <- 'Z:/antivir_screen/6-prestwick/6-14_IAV_titratration/170702-6-14-IAV-p3-frozen_Plate_224/Results/postprocessed/Graphs/' 
outputPlotNameBase <- paste(virusName, virusDilution, sep="_")
outputAnalysisDirectory <- 'Z:/antivir_screen/6-prestwick/6-14_IAV_titratration/170702-6-14-IAV-p3-frozen_Plate_224/Results/postprocessed/'
...
# Reorder and rename drugs for plotting
...
levels(plaqueOut$virus) <- c('non-infected\n', 'infected\n')
