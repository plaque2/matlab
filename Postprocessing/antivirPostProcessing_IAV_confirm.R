...
# User input
plaqueOutputFile <- 'N:/antivir_screen/6-prestwick/6-5_virus_confirmation/Results/170206-AntiVir-confirm-p18_Plate_3717_ImageData.csv'
layoutFile <- 'N:/antivir_screen/6-prestwick/6-5_virus_confirmation/Layouts/Est_p18_vIAV_d24e4.csv'
...
imagingPlateNumber = str_match(plaqueOutputFile, '(^.*/170206-AntiVir-confirm-p18_Plate_(.+)_ImageData.csv$)')[,3]
