...
# User input
plaqueOutputFile <- 'N:/antivir_screen/6-prestwick/6-12_HRV_confirmation/170619-RV-BafA1-frozen-Tit1_Plate_23/Results/170619-RV-BafA1-frozen-Tit1_Plate_23_ImageData.csv'
layoutFile <- 'N:/antivir_screen/6-prestwick/6-12_HRV_confirmation/170619-RV-BafA1-frozen-Tit1_Plate_23/Layouts/BafA_frozen_p2_vHRV-GFP_d25e4.csv'
...
imagingPlateNumber = str_match(plaqueOutputFile, '(^.*/170619-RV-BafA1-frozen-Tit1_Plate_(.+)_ImageData.csv$)')[,3]
head(imagingPlateNumber)

# Output setup
plotTitle = 'BafA: HRV-16-GFP (1:24,000), 2 dpi on HOG'
outputPlotDirectory <- 'N:/antivir_screen/6-prestwick/6-12_HRV_confirmation/170619-RV-BafA1-frozen-Tit1_Plate_23/Results/postprocessed/Graphs/' 
outputPlotNameBase <- paste(virusName, virusDilution, sep="_")
outputAnalysisDirectory <- 'N:/antivir_screen/6-prestwick/6-12_HRV_confirmation/170619-RV-BafA1-frozen-Tit1_Plate_23/Results/postprocessed/'
...
ggplot(plaqueOut_infected, aes(x=conc, y=relInfected))+
  # There is a bug in CalcFudgeAxis leading to 5x right y axis values therefore /5
  geom_boxplot(aes(x=conc, y=fudgeTotal/5), col='blue', width=0.4, outlier.colour = NA)+
