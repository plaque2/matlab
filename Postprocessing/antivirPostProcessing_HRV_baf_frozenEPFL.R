...
# User input
plaqueOutputFile <- 'N:/antivir_screen/6-prestwick/6-10_HRV-BAfAEPFL/20170528-BafA-p1_frozen_Plate_4146/Results/20170528-BafA-p1_frozen_Plate_4146_ImageData.csv'
layoutFile <- 'N:/antivir_screen/6-prestwick/6-10_HRV-BAfAEPFL/20170528-BafA-p1_frozen_Plate_4146/Layouts/BafA_frozen_p1_vHRV-GFP_d1e5.csv'
...
imagingPlateNumber = str_match(plaqueOutputFile, '(^.*/20170528-BafA_frozen-p1_Plate_(.+)_ImageData.csv$)')[,3]
head(imagingPlateNumber)

# Output setup
plotTitle = 'BafA_frozen: HRV-16-GFP (1:100,000), 2 dpi on HOG'
outputPlotDirectory <- 'N:/antivir_screen/6-prestwick/6-10_HRV-BAfAEPFLL/20170528-BafA-p1_frozen_Plate_4146/Results/postprocessed/Graphs/' 
outputPlotNameBase <- paste(virusName, virusDilution, sep="_")
outputAnalysisDirectory <- 'N:/antivir_screen/6-prestwick/6-10_HRV-BAfAEPFL/20170528-BafA-p1_frozen_Plate_4146/Results/postprocessed/'
...
infectionIndexInInfectedDMSOMean = infectedInInfectedMockMean / nucleiInInfectedMockMean
...
ggplot(plaqueOut_infected, aes(x=conc, y=relInfected))+
  # There is a bug in CalcFudgeAxis leading to 4x right y axis values therefore /4
  geom_boxplot(aes(x=conc, y=fudgeTotal/4), col='blue', width=0.4, outlier.colour = NA)+
