...
# User input
plaqueOutputFile <- 'N:/antivir_screen/6-prestwick/6-21-23_IAV_Z_a-b/Results/170915-6-23-IAV-pZ-b_Plate_834_ImageData.csv'
layoutFile <- 'N:/antivir_screen/6-prestwick/6-21-23_IAV_Z_a-b/Parameters/Zb_p4_sBSF018107_vIAV_d5e5.csv'
...
# Output setup
plotTitle = '\n BafA: IAV\n (1:500,000),\n 1 dpi on A549 ATCC'
outputPlotDirectory <- 'N:/antivir_screen/6-prestwick/6-21-23_IAV_Z_a-b/Results/postprocessed/Graphs/' 
outputPlotNameBase <- paste(virusName, zPlateNumber, virusDilution, sep="_")
outputAnalysisDirectory <- 'N:/antivir_screen/6-prestwick/6-21-23_IAV_Z_a-b/Results/postprocessed/'
...
# = - 3371841642.5
plaqueOut$totalVirusIntensityBackgroundSubstracted = plaqueOut$totalVirusIntensity - 3371841642.5 #(manual)
...
zFactorGfpBackIntensity = zFactor(plaqueOut$totalVirusIntensity, "DMSO", "BafA", 3371841642.5)
