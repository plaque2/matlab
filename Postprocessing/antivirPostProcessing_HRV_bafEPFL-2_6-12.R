...
# User input
plaqueOutputFile <- 'N:/antivir_screen/6-prestwick/6-12_HRV_confirmation/170619-RV-BafA1-Tit2_Plate_25/Results/170619-RV-BafA1-Tit2_Plate_25_ImageData.csv'
layoutFile <- 'N:/antivir_screen/6-prestwick/6-12_HRV_confirmation/170619-RV-BafA1-Tit2_Plate_25/Layouts/BafA_Tit2_p2_vHRV-GFP_d25e4.csv'
...
head(virusDilution)
establishmentPlateNumber = str_match(layoutFile, '(^.*/BafA_Tit2_p(.+)_v(.+)_d(.+).csv$)')[,3]
head(establishmentPlateNumber)
imagingPlateNumber = str_match(plaqueOutputFile, '(^.*/20170528-RV-BafA1-Tit2_Plate_(.+)_ImageData.csv$)')[,3]
head(imagingPlateNumber)

# Output setup
plotTitle = 'BafA: HRV-16-GFP (1:100,000), 2 dpi on HOG'
outputPlotDirectory <- 'N:/antivir_screen/6-prestwick/6-12_HRV_confirmation/170619-RV-BafA1-Tit2_Plate_25/Results/postprocessed/Graphs/' 
outputPlotNameBase <- paste(virusName, virusDilution, sep="_")
outputAnalysisDirectory <- 'N:/antivir_screen/6-prestwick/6-12_HRV_confirmation/170619-RV-BafA1-Tit2_Plate_25/Results/postprocessed/'
