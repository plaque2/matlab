...
# User input
plaqueOutputFile <- 'N:/antivir_screen/6-prestwick/6-21-23_IAV_Z_a-b/Results/170914-6-21-IAV-pZ-a_Plate_796_ImageData.csv'
layoutFile <- 'N:/antivir_screen/6-prestwick/6-21-23_IAV_Z_a-b/Parameters/Za_p3_sBSF018106_vIAV_d5e5.csv'
...
# = - 3437562432.5
plaqueOut$totalVirusIntensityBackgroundSubstracted = plaqueOut$totalVirusIntensity - 3437562432.5 #(manual)
...
zFactorGfpBackIntensity = zFactor(plaqueOut$totalVirusIntensity, "DMSO", "BafA", 3437562432.5)
