...
# User input
plaqueOutputFile <- 'N:/antivir_screen/6-prestwick/6-17_HAdV_preZ/170901-6-17-HAdV-preZ_Plate_705/Results/170901-6-17-HAdV-preZ_Plate_705_ImageData.csv'
layoutFile <- 'N:/antivir_screen/6-prestwick/6-17_HAdV_preZ/170901-6-17-HAdV-preZ_Plate_705/Layouts/preZ_p8_vHAdV_d5e5.csv'
...
imagingPlateNumber = str_match(plaqueOutputFile, '(^.*/170901-6-17-HAdV-preZ_(.+)_ImageData.csv$)')[,3]
head(imagingPlateNumber)

# Output setup
plotTitle = 'PreZ:HAdV-C2-dE3b-GFP (1:500,000), 3 dpi on A549 ATCC'
outputPlotDirectory <- 'N:/antivir_screen/6-prestwick/6-17_HAdV_preZ/Results/postprocessed/Graphs/' 
outputPlotNameBase <- paste(virusName, virusDilution, sep="_")
outputAnalysisDirectory <- 'N:/antivir_screen/6-prestwick/6-17_HAdV_preZ/Results/postprocessed/'
