...
# User input
plaqueOutputFile <- 'N:/antivir_screen/6-prestwick/6-13_IAV_confirmation/170623-6-13-IAV-p3_Plate_99/Results/170623-6-13-IAV-p3_Plate_99_ImageData.csv'
layoutFile <- 'N:/antivir_screen/6-prestwick/6-13_IAV_confirmation/170623-6-13-IAV-p3_Plate_99/Layouts/BafA_p3_vIAV_d24e5.csv'
...
imagingPlateNumber = str_match(plaqueOutputFile, '(^.*/170623-6-13-IAV-p3_Plate_(.+)_ImageData.csv$)')[,3]
head(imagingPlateNumber)

# Output setup
plotTitle = 'BafA: IAV (1:240,000), 1 dpi on A549 ATCC'
outputPlotDirectory <- 'N:/antivir_screen/6-prestwick/6-13_IAV_confirmation/170623-6-13-IAV-p3_Plate_99/Results/postprocessed/Graphs/' 
outputPlotNameBase <- paste(virusName, virusDilution, sep="_")
outputAnalysisDirectory <- 'N:/antivir_screen/6-prestwick/6-13_IAV_confirmation/170623-6-13-IAV-p3_Plate_99/Results/postprocessed/'
...
plaquesBafA_49nM_mean = mean(plaqueOut_infected[plaqueOut_infected$drug=='BafA' & plaqueOut_infected$conc=='049', 'numberOfPlaques'])
plaquesBafA_49nM_mean_normalized = mean(plaqueOut_infected[plaqueOut_infected$drug=='BafA' & plaqueOut_infected$conc=='049', 'normRelPlaques'])

normInfectionIndexBafA_49nM_mean = mean(plaqueOut_infected[plaqueOut_infected$drug=='BafA' & plaqueOut_infected$conc=='049', 'normRelInfected'])
normNumberOfNucleiBafA_49nM_mean = mean(plaqueOut_infected[plaqueOut_infected$drug=='BafA' & plaqueOut_infected$conc=='049', 'normRelNuclei'])
